...
class MuZeroConfig:
    def __init__(self):
        ...
        self.fc_dynamics_layers = [64, 64]  # [16, 16]  # Define the hidden layers in the dynamics network
        self.fc_reward_layers = [64, 64]  # [16, 16]  # Define the hidden layers in the reward network
        self.fc_value_layers = [64, 64]  # [16, 16]    # Define the hidden layers in the value network
        self.fc_policy_layers = [64, 64]  # [16, 16]   # Define the hidden layers in the policy network
...
class Game(AbstractGame):
    ...
    def reset(self):
        ...
        """
        return numpy.array([[self.env.reset(seed=self.seed)[0]]])
